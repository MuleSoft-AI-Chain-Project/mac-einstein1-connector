...
public class RequestHelper {
  ...
  private static void populateConnectionObject(HttpURLConnection conn, String accessToken) throws IOException {
    ...
    conn.setRequestProperty(X_SFDC_APP_CONTEXT, APP_CONTEXT_EINSTEIN_GPT);
    conn.setRequestProperty(X_CLIENT_FEATURE_ID, FEATURE_AI_PLATFORM_MODELS_CONNECTED_APP);
